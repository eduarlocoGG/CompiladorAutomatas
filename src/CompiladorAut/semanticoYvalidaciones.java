...
public class semanticoYvalidaciones {
	static public void checarSiExisteToken(identificadores variable) {
		for (int j = 0; j < lexicoYmas.tablaSimbolos.size(); j++) {
			if(lexicoYmas.tablaSimbolos.get(j).getNombre().equals(variable.getNombre())) {
				System.out.println("--------------------------------------------------------------------------------------------------------");
				System.out.println("Error en la inea: "+variable.getPos()+": La variable "+variable.getNombre()+" ya habia sido declarada con un tipo: "+lexicoYmas.tablaSimbolos.get(j).getTipoDato());
			}
		}	
	...
	static public void checarTipoDato(identificadores variable) {
		...
		if(tipoDato.equals("int")){
			try {
				...
				System.out.println("--------------------------------------------------------------------------------------------------------");
				System.out.println("Error en la linea: "+variable.getPos()+": El Identificador "+variable.getNombre()+" no es Entero(Int) - Debes utilizar el Tipo de Dato: "+variable.getTipoDato());
			}
		}
		if(tipoDato.equals("double")) {
			try {
				...
				System.out.println("--------------------------------------------------------------------------------------------------------");
				System.out.println("Error en la linea: "+variable.getPos()+": El Identificador "+variable.getNombre()+" no es Double- Debes utilizar el Tipo de Dato: "+variable.getTipoDato());
		...
		if(tipoDato.equals("string")){
			try {
				if(valor.startsWith("")&&valor.endsWith("\"")) {
					...
					System.out.println("--------------------------------------------------------------------------------------------------------");
					System.out.println("Error en la linea: "+variable.getPos()+": El Identificador "+variable.getNombre()+" no es un string- Debes utilizar comillas dobles: "+"\"Cadena de Ejemplo\"");
				}
			} catch (Exception e) {
		...
		if(tipoDato.equals("boolean")) {
			if (valor.equals("true") || valor.equals("false")) {
				...
				System.out.println("--------------------------------------------------------------------------------------------------------");
				System.out.println("Error en la linea: "+variable.getPos()+": El Identificador "+variable.getNombre()+" no es un Boolean- Debes utilizar: "+"true, false");
			}
		}
	...
	public static void obtenerDatoComparacion(String a, String b, int linea) {
		...
		if(temp1.isEmpty()) {
			System.out.println("Error en la linea "+linea+": la variable "+a+" no esta declarada");
			System.out.println("--------------------------------------------------------------------------------------------------------");
		}
		for (int j = 0; j < lexicoYmas.tablaSimbolos.size(); j++) {
			if(lexicoYmas.tablaSimbolos.get(j).getNombre().equals(a)) {
